Public Class frmCOA_generator
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If TextBox1.Text.Length = 0 Then
            MsgBox("Isian Kosong", MsgBoxStyle.Critical, "Error")
            Exit Sub
        End If
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        If ComboBox2.SelectedIndex = 1 Then
            If TextBox2.Text.Contains(vbTab) = False Then
                MsgBox("Isian tidak memiliki separator Tab", MsgBoxStyle.Critical, "Error")
                Exit Sub
            End If
        End If
        ...
        Else
            For i As Integer = TextBox2.Lines.Length To 1 Step -1
                ListBox2.Items.Insert(ListBox2.SelectedIndex + 1, kode & TextBox2.Lines(i - 1).Split(vbTab)(0))
                ListBox3.Items.Insert(ListBox2.SelectedIndex + 1, TextBox2.Lines(i - 1).Split(vbTab)(1))
            Next
        End If
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        If ListBox2.SelectedIndex < 0 Then
            MsgBox("Belum memilih kode rekening", MsgBoxStyle.Critical, "Error")
            Exit Sub
        End If
