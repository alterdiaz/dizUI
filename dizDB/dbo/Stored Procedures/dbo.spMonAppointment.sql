CREATE PROCEDURE dbo.spMonAppointment
@tanggal date,
@paramedis as bigint,
@sesi as bigint
AS
...
where ps.idparamedisspesialis=@paramedis 
and a.idjadwalsesi=@sesi 
and convert(varchar,a.bookingdate,105)=convert(varchar,@tanggal,105) 
order by a.nomorurut asc
END
