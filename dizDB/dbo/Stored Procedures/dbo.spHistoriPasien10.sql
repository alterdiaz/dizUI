CREATE PROCEDURE dbo.spHistoriPasien10
@id as integer
AS
BEGIN
select top 10 0 as nomor,
...
left join alamat a on rm.idrekammedis=a.idreff and a.tablereff='PASIEN' 
...
where r.isdeleted=0 and r.idrekammedis=@id
