...
Public Class UNCAccessWithCredentials
    ...
    Friend Shared Function NetUseAdd(ByVal UncServerName As LPWSTR, ByVal Level As DWORD, ByRef Buf As USE_INFO_2, ByRef ParmError As DWORD) As NET_API_STATUS
    End Function
