...
#Region "Overloads"
    ...
    Public Overloads Function datasetSave(ByVal TableName As String, ByVal idValueData As String, ByVal Field As List(Of String), ByVal Value As List(Of Object), ByVal ShowMsg As Boolean) As Boolean
        ...
        '    MsgBox("Index pertama bukan id tabel", MsgBoxStyle.Critical, "Kesalahan")
        '    retval = False
        'Else

        'Me.checkConnection()
        'If dbStat = False Then
        '    MsgBox("Tidak terhubung dengan database", MsgBoxStyle.Critical, "Kesalahan")
        '    retval = False
        'Else
        ...
        '    MsgBox("Field pada Parameter dan Tabel tidak sama", MsgBoxStyle.Critical, "Kesalahan")
        '    retval = False
        'Else
        sqlConn.ConnectionString = strConn
        ...
        Catch ex As Exception
            ...
            retval = False
            If ShowMsg = True Then
                MsgBox("Data tidak tersimpan" & vbCrLf & "Koneksi jaringan terputus atau hubungi administrator" & vbCrLf & ex.Message, MsgBoxStyle.Information, "Informasi")
            End If
        End Try
        'End If
        'End If
...
#Region "Properties"
    ...
    Public ReadOnly Property getDataSetRowCount(ByVal DataTableName As String) As Integer
        Get
            Try
                Return dtset.Tables(DataTableName).Rows.Count
            Catch ex As Exception
    ...
    Public ReadOnly Property getDataSetColumnCount(ByVal DataTableName As String) As Integer
        Get
            Return dtset.Tables(DataTableName).Columns.Count
        End Get
    End Property
    ...
    Public ReadOnly Property dataTable(ByVal DataTableName As String) As DataTable
        Get
            Return dtset.Tables(DataTableName)
        End Get
    End Property
