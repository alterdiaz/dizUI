        ...
        If retval = True Then
            ...
            If isautoreview = "1" Then
                ...
                For i As Integer = 0 To gvData.RowCount - 1
                    ...
                    valuelog.AddRange(New Object() {iditemlog, iditem, iddept2, idunit2, iddata, "Transaksi", iddatadt, "TransaksiDT", teKode.Text, "Penerimaan Barang", qty, 1, "Penerimaan Barang " & vbCrLf & teKode.Text, userid, nowTime})
