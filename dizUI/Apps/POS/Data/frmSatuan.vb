Public Class frmSatuan
    ...
    Private Sub loadGrid()
        ...
        mysqls.DMLQuery("select s.idsatuan,s.satuan,s.isdeleted,d.generalcode as statdata from satuan s left join sys_generalcode d on d.idgeneral=s.isdeleted and d.gctype='DELETE'", "data")
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        If btnDelete.Text = "HAPUS" Then
            field.AddRange(New String() {"idsatuan", "isdeleted", "updatedby", "updateddate"})
            value.AddRange(New Object() {idData, 1, userid, nowTime})
            retval = sqls.datasetSave("satuan", idData, field, value, False)
            If retval Then
        ...
        Else
            ...
            End If
        End If
        isiLog(userid, dbstring, field, value, "satuan")
    ...
    Private Sub gvData_FocusedRowChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles gvData.FocusedRowChanged
        Try
            ...
            teNama.Text = dcol("satuan")

            idData = dcol("idsatuan")
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        checkFieldMaxLength(dbstring, tlpField, "satuan")
        btnNew_Click(Me, Nothing)
    End Sub
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If statData = statusData.Baru Then
            idData = GenerateGUID()
            field.AddRange(New String() {"idsatuan", "idcompany", "satuan", "isdeleted", "createdby", "createddate"})
            value.AddRange(New Object() {idData, idcomp, teNama.Text, 0, userid, nowTime})
        Else
            field.AddRange(New String() {"idsatuan", "satuan", "updatedby", "updateddate"})
            value.AddRange(New Object() {idData, teNama.Text, userid, nowTime})
        End If

        If dtSQL.datasetSave("satuan", idData, field, value, False) = True Then
