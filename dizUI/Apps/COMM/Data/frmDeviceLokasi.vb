Public Class frmDeviceLokasi
    ...
    Private Sub loadGrid()
        ...
        mysqls.DMLQuery("select dl.iddevicelokasi,dl.iddevice,dl.idlokasi,d.device,l.nama as lokasi,dl.isdeleted,del.generalcode as statdata,dl.devicelokasi from devicelokasi dl left join sys_device d on dl.iddevice=d.iddevice left join lokasi l on dl.idlokasi=l.idlokasi left join sys_generalcode del on dl.isdeleted=del.idgeneral and del.gctype='DELETE' order by d.device asc,l.nama asc", "data")
    ...
    Private Sub loadLOV()
        Dim mysqls As New SQLs(dbstring)
        mysqls.DMLQuery("select iddevice as id,device +' ('+ipaddress+')' as content from sys_device order by iddevice asc", "device")
        lueDevice.Properties.DataSource = mysqls.dataTable("device")
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If statData = statusData.Baru Then
            idData = GenerateGUID()
            field.AddRange(New String() {"iddevicelokasi", "iddevice", "idlokasi", "devicelokasi", "isdeleted", "createdby", "createddate"})
            value.AddRange(New Object() {idData, lueDevice.EditValue, lueLokasi.EditValue, teKeterangan.Text, 0, userid, nowTime})
        Else
            field.AddRange(New String() {"iddevicelokasi", "iddevice", "idlokasi", "devicelokasi", "isdeleted", "updatedby", "updateddate"})
            value.AddRange(New Object() {idData, lueDevice.EditValue, lueLokasi.EditValue, teKeterangan.Text, 0, userid, nowTime})
        End If

        If dtSQL.datasetSave("devicelokasi", idData, field, value, False) = True Then
            dizMsgbox("Data tersimpan", dizMsgboxStyle.Info, Me)
            isiLog(userid, dbstring, field, value, "devicelokasi")
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        If btnDelete.Text = "HAPUS" Then
            field.AddRange(New String() {"iddevicelokasi", "isdeleted", "updatedby", "updateddate"})
            value.AddRange(New Object() {idData, 1, userid, nowTime})
            retval = sqls.datasetSave("devicelokasi", idData, field, value, False)
            If retval Then
    ...
    Private Sub gvData_FocusedRowChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles gvData.FocusedRowChanged
        Try
            ...
            lueLokasi.EditValue = dcol("idlokasi")
            teKeterangan.Text = dcol("devicelokasi")

            idData = dcol("iddevicelokasi")
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        checkFieldMaxLength(dbstring, tlpField, "devicelokasi")
        btnNew_Click(Me, Nothing)
    End Sub
