Public Class frmNeracaTahunan
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        gvData.ViewCaption = "Neraca Tahun " & CDate(deTanggal.EditValue).Year
    ...
    Private Sub frmNeraca_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strQuery = ""
        strTemplate = ""
        Dim tmparr() As String = IO.File.ReadAllLines(appPath & "NeracaTahunanBulan.txt")
        For i As Integer = 0 To tmparr.Length - 1
            ...
            End If
        Next
        Dim tmparrtmp() As String = IO.File.ReadAllLines(appPath & "NeracaTahunan.txt")
