Public Class frmNeracaBulanan
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        str = str.Replace("*BULAN*", CInt(Format(CDate(deTanggal.EditValue), "MM")))
        str = str.Replace("*TAHUN*", Format(CDate(deTanggal.EditValue), "yyyy"))
        sqls.DMLQuery(str, "data")
        gcData.DataSource = sqls.dataTable("data")
        gvData.BestFitColumns()
        gvData.ViewCaption = "Neraca Bulan " & NamaBulan(Format(CDate(deTanggal.EditValue), "MM")) & " " & CDate(deTanggal.EditValue).Year
    ...
    Private Sub frmNeraca_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strQuery = ""
        Dim tmparr() As String = IO.File.ReadAllLines(appPath & "NeracaBulanan.txt")
