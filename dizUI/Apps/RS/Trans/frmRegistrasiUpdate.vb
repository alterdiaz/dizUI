Public Class frmRegistrasiUpdate
    ...
    Private Sub loadLOV()
        ...
        sqls.DMLQuery("select idtransactiontype from transactiontype where kodetransaksi='REG' and iddepartment in (select [value] from sys_appsetting where variable in ('IDInpatientDept'))", "idtranstype")
        ...
        For i As Integer = 0 To gvData.RowCount - 1
            ...
            If dra.RowState = DataRowState.Modified Then
                If dra("cek") = "True" Then
                    ...
                    Else
                        sqls = New SQLs(dbstring)
                        sqls.DMLQuery("select idregistrasi from registrasi where isasesmenmedis=1 and idregistrasi='" & dra("idregistrasi") & "'", "cekasm")
                    ...
                    If dra("registrasino") <> regno And CLng(dra("transactiontype")) = idtranstype Then
                        sqls = New SQLs(dbstring)
                        ...
                        If sqls.getDataSet("getidregkamar") > 0 Then
                            ...
                            value.AddRange(New Object() {idkamar, 0, DBNull.Value, 1, userid, nowTime})
