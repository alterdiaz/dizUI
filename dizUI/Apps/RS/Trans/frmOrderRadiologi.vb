    ...
    Private Sub frmOrderRadiologi_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If _idreginduk <> "" Then
            ...
            Else
                ...
                sqls.DMLQuery("select idrekammedis,payertype,asalpx,asalpx2,idpayer,idasuransi,ishamil,iddokterruangan,idspesialisruangan from registrasi where idregistrasi='" & _idreginduk & "'", "getidrm")
