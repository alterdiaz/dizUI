Public Class frmPelayananSelect
    ...
    Private Sub btnKonsultasi_Click(sender As Object, e As EventArgs) Handles btnKonsultasi.Click, btnPemeriksaan.Click, btnPemeriksaanAPS.Click, btnIGD.Click, btnIGDelektif.Click, btnUmum.Click, btnRehabilitasi.Click
        txtPilih = sender.tag
