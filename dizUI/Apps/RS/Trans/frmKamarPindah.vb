Public Class frmKamarPindah
    ...
    Private Sub frmKamarPindah_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If idreg = "-1" Then
            ...
            teKelasTujuan.EditValue = Nothing
        Else
    ...
    Private Sub lueRuangTujuan_EditValueChanged(sender As Object, e As EventArgs) Handles lueRuangTujuan.EditValueChanged
        ...
        If sqls.getDataSet("getid") > 0 Then
            teKelasTujuan.Text = sqls.getDataSet("getid", 0, "kelas")
        End If
    End Sub

    Private Sub btnNew_Click(sender As Object, e As EventArgs) Handles btnNew.Click
        Dim sqls As New SQLs(dbstring)
        sqls.CallSP("spMonKamarAktif", "data")
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        field.AddRange(New String() {"idkamar", "idregistrasi", "checkin", "statusbed", "updatedby", "updateddate", "idcompany"})
        value.AddRange(New Object() {idkamarasal, 0, DBNull.Value, 1, userid, nowTime, idcomp})
