Public Class frmMonRegisterIRNAday
    Const HTCAPTION = &H2
    ...
    Private Sub loadgrid()
        ...
        sqls.CallSP("spMonRegisterRIDay", "monreg", field, value)
        gvData.ViewCaption = "Register IRNA - " & CDate(deTanggal.EditValue).Day & " " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
