Public Class frmMonRegisterIRMday
    Const HTCAPTION = &H2
    ...
    Private Sub ribeASM_ButtonClick(sender As Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles ribeASM.ButtonClick
        If gvData.FocusedRowHandle >= 0 Then
            ...
            previewBerkasAMIGD(idasm, idreg, noform, cu.preview)
        End If
    End Sub
    ...
    Private Sub previewBerkasAMIGD(iddata As String, idreg As String, nomorform As String, cetaktype As cu)
        If nomorform = "AMIRM201801" Then
