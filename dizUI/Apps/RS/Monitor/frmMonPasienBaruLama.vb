Public Class frmMonPasienBaruLama
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(sender As Object, e As EventArgs) Handles deTanggal.EditValueChanged
        ...
        value.AddRange(New Object() {CDate(deTanggal.EditValue).Year})
        sqls.CallSP("spMonPasienBaruLama", "MonPasienBaruLama", field, value)
        gvData.ViewCaption = "Monitoring Pasien Baru Lama - " & CDate(deTanggal.EditValue).Year

        gcData.DataSource = sqls.dataTable("MonPasienBaruLama")
