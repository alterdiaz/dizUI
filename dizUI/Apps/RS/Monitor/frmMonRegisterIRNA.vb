Public Class frmMonRegisterIRNA
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        sqls.CallSP("spMonRegisterRI", "monregri", field, value)

        gcData.DataSource = sqls.dataTable("monregri")
        ...
        gvData.ViewCaption = "Register Rawat Inap - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
