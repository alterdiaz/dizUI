...
Public Class frmBoardPelayanan
    ...
    Private Sub loadRegister(param As String)
        ...
        Dim series3 As New DevExpress.XtraCharts.Series("Dirujuk", DevExpress.XtraCharts.ViewType.Bar)
        Dim series4 As New DevExpress.XtraCharts.Series("Pulang APS", DevExpress.XtraCharts.ViewType.Bar)
        ...
        Dim series7 As New DevExpress.XtraCharts.Series("Tutup", DevExpress.XtraCharts.ViewType.Bar)
