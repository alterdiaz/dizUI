    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        If statData = statusData.Baru Then
            If teNoRM.Text <> "00-00-00-00" Then
                ...
                'sqls.DMLQuery("select nama from rekammedis where idcompany=(select top 1 value from sys_appsetting where variable='CompanyID') and rekammedisno<>0 and replace(nama,' ','')='" & teNama.Text.Replace(" ", "") & "'", "cek")
        ...
        If cari.ShowDialog = Windows.Forms.DialogResult.OK Then
            ...
            Else
                ...
                If sqls.getDataSet("keluarga") > 0 Then
                    ...
                    sqls.DMLQuery("select idalamat,idnegara,idpropinsi,idkabupaten,idkecamatan,idkelurahan,alamat,kodepos from alamat where isdeleted=0 and isprimary=1 and addresstype=2 and tablereff='KELUARGAPASIEN'", "kalamat")
