Public Class frmFarmasiRujukan
    Const HTCAPTION = &H2
    ...
    Private Sub loadLOV()
        Dim mysqls As New SQLs(dbstring)
        mysqls.DMLQuery("select idgeneral as id,generalcode as content from sys_generalcode where generalcode='FARMASI' and gctype='BPTYPE'", "type")
