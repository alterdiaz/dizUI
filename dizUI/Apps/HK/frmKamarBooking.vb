...
Public Class frmKamarBooking
    ...
    Private Sub gvData_DoubleClick(sender As Object, e As EventArgs) Handles gvData.DoubleClick
        ...
        If idxFocus >= 0 Then
            ...
            Dim frmMon As New frmKamarBookingEntry(iddata)
            tambahChild(frmMon)
