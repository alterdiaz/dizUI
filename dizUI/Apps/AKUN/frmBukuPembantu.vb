Public Class frmBukuPembantu
    ...
    Private Sub frmBukuPembantu_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        mysqls.DMLQuery("select idcoa, coa, remarks from coa where idcoa in (select distinct(idcoa) as idcoa from jurnal) and len(convert(decimal(20,0),COA))>=3 and (isnull(isdeleted,0)=0 or coa<>'-1') order by convert(varchar(20),COA) asc", "coa")
