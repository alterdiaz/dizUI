Public Class frmNeracaSaldo
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        str = str.Replace("*BULANTAHUN*", Format(CDate(deTanggal.EditValue), "yyyy-MM"))
    ...
    Private Sub frmNeracaSaldo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strQuery = ""
        Dim tmparr() As String = IO.File.ReadAllLines(appPath & "NeracaSaldo.txt")
