Public Class frmKlien
    ...
    Private Sub loadLOV()
        Dim mysqls As New SQLs(dbstring)
        mysqls.DMLQuery("select idgeneral as id,generalcode as content from sys_generalcode where generalcode='KLIEN' and gctype='BPTYPE'", "type")
