...
Public Class frmReturPembelianBarangReview
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        For i As Integer = 0 To gvData.RowCount - 1
            ...
            valuelog.AddRange(New Object() {iditemlog, iditem, iddept2, idunit2, idData, "Transaksi", iddatadt, "TransaksiDT", teKode.Text, "Retur Pembelian Barang", qty, 2, "Retur Pembelian " & vbCrLf & teKode.Text, userid, nowTime})
