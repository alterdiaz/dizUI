Public Class frmMonReturPembelianBarang
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged, lueUnit.EditValueChanged
        ...
        Try
            ...
            sqls.CallSP("spMonRETB", "parent", field, value)
            ...
            sqls.CallSP("spMonRETBdt", "child", field2, value2)
            ...
            gvDetil.OptionsView.ColumnAutoWidth = False
            ...
            gvData.BestFitColumns()
            gvDetil.BestFitColumns()
            gvData.ViewCaption = "Retur Pembelian Barang - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year & " " & lueUnit.Text
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        If gvData.FocusedRowHandle < 0 Then
            dizMsgbox("Belum memilih data", dizMsgboxStyle.Kesalahan, Me)
            Exit Sub
        End If
    ...
    Private Sub cetakBerkas(iddata As String, cetaktype As cu, Optional printername As String = "")
        ...
        mys.CallSP("spRETB", "spRETB", fieldctk, valuectk)
        mys.CallSP("spRETBdt", "spRETBdt", fieldctk, valuectk)

        Dim rpt As New xrRETB
        ...
        rpt.DataMember = "spRETBdt"
        rpt.DisplayName = "RETB"
        ...
        If cetaktype = cu.cetak Then
            If printername = "" Then
                ...
                End Try
            Else
                Dim sharename As String = getPrinter("RETB")
                If sharename <> "" Then
                    Try
                        pt.Print(sharename)
                    Catch ex As Exception
