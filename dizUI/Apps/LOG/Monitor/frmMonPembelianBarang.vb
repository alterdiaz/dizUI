Public Class frmMonPembelianBarang
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged, lueUnit.EditValueChanged
        ...
        Try
            ...
            sqls.CallSP("spMonPO", "parent", field, value)
            ...
            sqls.CallSP("spMonPOdt", "child", field2, value2)
            ...
            gvData.BestFitColumns()
            gvDetil.BestFitColumns()
            gvData.ViewCaption = "Pembelian Barang - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year & " " & lueUnit.Text
    ...
    Private Sub cetakBerkas(iddata As String, cetaktype As cu, Optional printername As String = "")
        ...
        mys.CallSP("spPO", "spPO", fieldctk, valuectk)
        mys.CallSP("spPOcurrent", "spPOcurrent", fieldctk, valuectk)
        ...
        If cetaktype = cu.cetak Then
            If printername = "" Then
                ...
                End Try
            Else
                Dim sharename As String = getPrinter("PO")
                If sharename <> "" Then
                    Try
                        pt.Print(sharename)
                    Catch ex As Exception
