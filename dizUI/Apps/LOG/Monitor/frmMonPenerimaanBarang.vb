Public Class frmMonPenerimaanBarang
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged, lueUnit.EditValueChanged
        ...
        Try
            ...
            sqls.CallSP("spMonBPB", "parent", field, value)
            ...
            sqls.CallSP("spMonBPBdt", "child", field2, value2)
            ...
            gvData.BestFitColumns()
            gvDetil.BestFitColumns()
            gvData.ViewCaption = "Penerimaan Barang - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year & " " & lueUnit.Text
    ...
    Private Sub cetakBerkas(iddata As String, cetaktype As cu, Optional printername As String = "")
        ...
        mys.CallSP("spBPB", "spBPB", fieldctk, valuectk)
        mys.CallSP("spBPBcurrent", "spBPBcurrent", fieldctk, valuectk)

        Dim rpt As New xrBPB
        ...
        If cetaktype = cu.cetak Then
            If printername = "" Then
                ...
                End Try
            Else
                Dim sharename As String = getPrinter("BPB")
                If sharename <> "" Then
                    Try
                        pt.Print(sharename)
                    Catch ex As Exception
