Public Class frmMutasiBarang
    ...
    Private Sub lueUnit_EditValueChanged(sender As Object, e As EventArgs) Handles lueUnit.EditValueChanged, lueDepartment.EditValueChanged, deTanggal.EditValueChanged, slueItem.EditValueChanged
        ...
        If lueDepartment.EditValue Is Nothing Then
            cek = False
        End If
        If slueItem.EditValue Is Nothing Then
            cek = False
        End If
        ...
        field.AddRange(New String() {"@tahun", "@bulan", "@idunit", "@iddept", "@iditem"})
        value.AddRange(New Object() {CDate(deTanggal.EditValue).Year, CDate(deTanggal.EditValue).Month, lueUnit.EditValue, lueDepartment.EditValue, slueItem.EditValue})
        sqls.CallSP("spMonItemMutasi", "mutasi", field, value)

        gcData.DataSource = sqls.dataTable("mutasi")
        gvData.BestFitColumns()
        gvData.ViewCaption = "Mutasi Barang " & slueItem.Text & " - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
    ...
    Private Sub loadLOV()
        ...
        slueItem.Properties.DataSource = sqls.dataTable("item")
        slueItem.Properties.ValueMember = "id"
        slueItem.Properties.DisplayMember = "content"
        slueItem.EditValue = Nothing
    End Sub
