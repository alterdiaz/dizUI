...
Public Class frmPermintaanPembelianAllUnit
    ...
    Private Sub loadgrid(idunit As String)
        ...
        sqls.CallSP("spSPPallunit", "spp") ', field, value)
        dttbl = sqls.dataTable("spp")
        gcData.DataSource = dttbl

        Dim sqls1 As New SQLs(dbstring)
        sqls1.CallSP("spSPPallunitturunan", "sppturunan") ', field, value)
