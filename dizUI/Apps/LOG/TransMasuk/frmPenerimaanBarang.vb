...
Public Class frmPenerimaanBarang
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If isautoreview = "0" Then
            ...
            Else
                field.AddRange(New String() {"idtransaksi", "idtransaksireff", "transaksitype", "transaksino", "transaksistatus", "idasal", "asaltype", "idtujuan", "tujuantype", "iddepttujuan", "isdeleted", "remarks", "dokumenno2", "updatedby", "updateddate", "updatedfromip", "updatedfromhostname", "idcompany", "kirimdate", "tempodate", "subtotal", "discsubtotal", "subtotaldisc", "ppn", "subtotaldiscppn", "subtotaldiscppnongkir"})
            End If
    ...
    Private Sub gvData_CellValueChanged(sender As Object, e As CellValueChangedEventArgs) Handles gvData.CellValueChanged
        ...
        ElseIf e.Column Is GridColumn5 Then
            ...
            Dim isi As Decimal = CDec(gvData.GetRowCellValue(e.RowHandle, GridColumn5))
            gvData.SetRowCellValue(e.RowHandle, gcQty, isi * qtyfakt)
        ElseIf e.Column Is GridColumn2 Then
            Dim harga As Decimal = CDec(e.Value)
            Dim qtyfakt As Decimal = CDec(gvData.GetRowCellValue(e.RowHandle, GridColumn3))
            Dim discP As Decimal = CDec(gvData.GetRowCellValue(e.RowHandle, GridColumn11))
            ...
            gvData.SetRowCellValue(e.RowHandle, GridColumn10, discR)
            gvData.SetRowCellValue(e.RowHandle, GridColumn12, subtotppn)
        ElseIf e.Column Is GridColumn10 Then
            Dim harga As Decimal = CDec(gvData.GetRowCellValue(e.RowHandle, GridColumn2))
            Dim qtyfakt As Decimal = CDec(gvData.GetRowCellValue(e.RowHandle, GridColumn3))
            Dim discP As Decimal = (CDec(gvData.GetRowCellValue(e.RowHandle, GridColumn10)) / harga) * 100
            ...
            'gvData.SetRowCellValue(e.RowHandle, GridColumn10, discR)
            gvData.SetRowCellValue(e.RowHandle, GridColumn11, discP)
            gvData.SetRowCellValue(e.RowHandle, GridColumn12, subtotppn)
        ElseIf e.Column Is GridColumn11 Then
            Dim harga As Decimal = CDec(gvData.GetRowCellValue(e.RowHandle, GridColumn2))
            Dim qtyfakt As Decimal = CDec(gvData.GetRowCellValue(e.RowHandle, GridColumn3))
