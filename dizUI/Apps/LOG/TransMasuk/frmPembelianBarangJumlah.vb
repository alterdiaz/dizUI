...
Public Class frmPembelianBarangJumlah
    Const HTCAPTION = &H2
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        sqls.DMLQuery("select top 1 convert(bigint,value) as value from sys_appsetting where variable='AllowAutoReviewPOjumlah'", "autoreview")
        ...
        If Asc(e.KeyChar) = 13 Then
            ...
            If sqls.getDataSet("getitem") > 0 Then
                ...
                If cekExist = False Then
                    ...
                    dr("idtransaksidt") = "0"
                    dr("iditem") = iditem
                    sqls.DMLQuery("Select i.iditem,i.itemtype,i.idsatuan,gc.generalcode As type,i.kode,i.item,i.isppn,s.satuan,0 As qty from item i left join sys_generalcode gc On gc.idgeneral=i.itemtype And gc.gctype='ITEMTYPE' left join satuan s on s.idsatuan=i.idsatuan where i.iditem='" & iditem & "'", "dataitem")
                    dr("itemtype") = sqls.getDataSet("dataitem", 0, "itemtype")
                    dr("idsatuan") = sqls.getDataSet("dataitem", 0, "idsatuan")
                    dr("type") = sqls.getDataSet("dataitem", 0, "type")
                    dr("kode") = sqls.getDataSet("dataitem", 0, "kode")
