...
Public Class frmSupplierPembayaran
...
isnull(pt.idpaymenttrans,'-1') as idpaymenttrans,t.idtransaksi,t.transaksino,t.dokumenno,convert(varchar,t.createddate,105)+' '+convert(varchar,t.createddate,108) as tanggaltransaksi,t.subtotaldiscppnongkir as nominal,t.remarks from transaksi t left join paymenttrans pt on t.idtransaksi=pt.idtransaksi where t.idasal='" & lueSupplier.EditValue & "' and t.idtujuan='" & lueUnit.EditValue & "' and isnull(pt.idpaymenttrans,'-1')='-1' order by t.createddate asc", "transaksi")
    ...
    Private Sub btnBayarSimpan_Click(sender As Object, e As EventArgs) Handles btnBayarSimpan.Click
        ...
        If statbayar = statusData.Baru Then
            Dim pair As KeyValuePair(Of String, String) = generateno2(lueUnit.EditValue, iddept, "Payment Received Pembelian", False)
        ...
        If dtsql.datasetSave("paymentdt", idBayar, field, value, False) = True Then
            ...
            If cekcoa = True Then
                ...
                valuej.Clear()
                valuej.AddRange(New Object() {idjurnal, tgljurnal, seNominalBayar.Value, "Payment Pembelian " & vbCrLf & teNoPaymentRcv.Text, teNoPaymentRcv.Text, 2, 0, userid, tgljurnal, teNoteBayar.Text, 0, 1, "PaymentDT", "-", slueKCOA.EditValue, slueKCOA.EditValue, idBayar, "0", lueUnit.EditValue, idcomp})
                ...
                valuej.Clear()
                valuej.AddRange(New Object() {idjurnal, tgljurnal, seNominalBayar.Value, "Payment Pembelian " & vbCrLf & teNoPaymentRcv.Text, teNoPaymentRcv.Text, 1, 0, userid, tgljurnal, teNoteBayar.Text, 0, 1, "PaymentDT", "-", slueKCOA.EditValue, slueKCOA.EditValue, idBayar, "0", lueUnit.EditValue, idcomp})
                dtjurnal.datasetSave("jurnal", idjurnal, fieldj, valuej, False)
            End If
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If statdata = statusData.Baru Then
            Dim pair As KeyValuePair(Of String, String) = generateno2(lueUnit.EditValue, iddept, "Payment Pembelian", False)
