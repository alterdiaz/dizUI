...
Public Class frmReturPembelian
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If statData = statusData.Baru Then
            Dim pair As KeyValuePair(Of String, String) = generateno2(idunit, iddept, "Retur Pembelian", False)
        ...
        Else
            ...
            For i As Integer = 0 To gvData.RowCount - 1
                ...
                valuelog.AddRange(New Object() {iditemlog, iditem, iddept, idunit, idData, "Transaksi", iddatadt, "TransaksiDT", teKode.Text, "Penerimaan Barang", qty, 2, "Retur Pembelian " & teReturNo.Text, userid, nowTime})
    ...
    Private Sub btnNew_Click(sender As Object, e As EventArgs) Handles btnNew.Click
        ...
        If cari.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            Dim pair As KeyValuePair(Of String, String) = generateno2(idunit, iddept, "Retur Pembelian", True)
            Dim idtrans As String = pair.Key
            Dim notrans As String = pair.Value
            teReturNo.Text = notrans
            Me.idtrans = idtrans
