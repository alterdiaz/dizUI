...
Public Class frmEditNoteReason
    Const HTCAPTION = &H2
    ...
    Private Sub frmEditNoteReason_Load(sender As Object, e As EventArgs) Handles Me.Load
        tboReason.Focus()
        Me.ActiveControl = tboReason
    End Sub

    Private Sub frmEditNoteReason_Invalidated(sender As Object, e As InvalidateEventArgs) Handles Me.Invalidated
        tboReason.Focus()
        Me.ActiveControl = tboReason
    End Sub

    Private Sub tboReason_KeyPress(sender As Object, e As KeyPressEventArgs) Handles tboReason.KeyPress
