Public Class frmMonAnggaranRutin
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        bgvData.ViewCaption = "Anggaran dan Realiasasi Tahun " & CDate(deTanggal.EditValue).Year
        Dim str As String = strQuery
        str = str.Replace("*TAHUN*", CDate(deTanggal.EditValue).Year)

        Dim mys As New SQLs(dbstring)
        mys.DMLQuery(str, "data")
    ...
    Private Sub frmMonAnggaranRutin_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strQuery = ""
        Dim tmparr() As String = IO.File.ReadAllLines(appPath & "MonAngBulanan.txt")
    ...
    Private Sub btnExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        If bgvData.RowCount > 0 Then
            Dim exp As New frmExport(bgvData)
            tambahChild(exp)
            exp.ShowDialog()
        Else
