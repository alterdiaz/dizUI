Public Class frmExternalPUMPB
    ...
    '        formatStr = "UM" & Format(nowTime, "MMyyyy") & "/"
    '        currid = 1
    '        posnumber = "Belakang"
    '        lenId = 4
    '    Else
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        ...
        mys.DMLQuery("select k.idstaff,k.nama,p.idposition,p.position,d.iddepartment,d.kode,d.department,k.idunit,un.unit from staff k left join unit un on k.idunit=un.idunit left join position p on k.idposition=p.idposition left join department d on k.iddepartment=d.iddepartment where k.nik='VENDOR'", "datakary")
        ...
        Dim pair As KeyValuePair(Of String, String) = generateno2("", "", "Pengajuan Ext", True)
    ...
    Private Sub frmExternalUMPB_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If formTitle <> "" Then
            Me.Text = formTitle
        ...
        Dim mysqls As New SQLs(dbstring)
        mysqls.DMLQuery("select idkategoriuntuk, kategoriuntuk from kategoriuntuk where isdeleted=0", "kategoriuntuk")
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If dizMsgbox("Tanggal pengajuan : " & Format(deTanggal.EditValue, "dd-MM-yyyy") & vbCrLf & "Apakah tanggal sudah benar ?", dizMsgboxStyle.Konfirmasi, Me) = dizMsgboxValue.OK Then
            ...
            If teNamaPemohon.EditValue Is Nothing Then
                isKosong = True
            End If
            If teNamaPemohon.Text = "" Then
                isKosong = True
            End If
            ...
            If isKosong = True Then
                ...
                Exit Sub
            End If
            If meUntuk.Text.Replace(" ", "") = "SALDOAWAL" Then
            ...
            Dim pair As KeyValuePair(Of String, String) = generateno2("", "", "Pengajuan Ext", False)
            Dim idtrans As String = pair.Key
            Dim notrans As String = pair.Value

            tePengajuanNo.Text = notrans
            staffname = teNamaPemohon.Text
            ...
            value.AddRange(New Object() {idtmp, idcomp, slueCOA.EditValue, tePengajuanNo.Text, CDate(deTanggal.EditValue), nudJumlahUang.Value, teHurufUang.Text, "( " & lueKategori.Text & " )" & vbCrLf & meUntuk.Text, staffid, unitid, staffname, levelname, deptname, 0, 0, "-", 2})
