Public Class frmReportPUMPB
    ...
    Private Sub frmReportPUMPB_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        gvData.Focus()
    End Sub

    Private Sub frmReportPUMPB_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If formTitle <> "" Then
            Me.Text = formTitle
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        If gvData.RowCount = 0 Then
            'MsgBox("Data tidak ditemukan", dizMsgboxStyle.peringatan, Me)
