...
Public Class frmFormIBS201901
    ...
    Private Sub showCPPT(Optional idreg As String = "0", Optional isdeleted As Long = 0, Optional tanggal As Object = Nothing)
        ...
        If isdeleted = 1 Then
            sqls.DMLQuery("select case when tt.iddepartment in (select value from sys_appsetting where variable in('IDICUDept','IDICCUDept','IDHCUDept')) then 'OK' else 'NOT' end as cekdept,dp.idsoapnote,dp.idparamediscreator,dp.idspesialiscreator,dp.paramediscreatortype,pa.nama as paramedis,ps.nama as spesialis,dt.generalcode as dpjptype,sd.generalcode as statdata,dp.planning,dt.priority as dpjpprioritas,dp.isdeleted,case when pt.idreff=1 then isnull(pa.nama,0) + isnull(' (' + ps.nama + ')' ,'') + case when dp.reviewedby is null then ' - Belum Direview' else ' - Sudah Direview' end + char(13) + char(10) + 'sebagai ' + dt.generalcode + ' ' + convert(varchar,dp.createddate,105) + ' ' + convert(varchar,dp.createddate,108) + char(13) + char(10) + 'S: ' + dp.subyektif + char(13) + char(10) + 'B: ' + dp.obyektif + char(13) + char(10) + 'A: ' + dp.asesmen + char(13) + char(10) + 'R: ' + dp.planning else isnull(pa.nama,0) + isnull(' (' + ps.nama + ')' ,'') + case when dp.reviewedby is null then ' - Belum Direview' else ' - Sudah Direview' end + char(13) + char(10) + 'sebagai ' + dt.generalcode + ' ' + convert(varchar,dp.createddate,105) + ' ' + convert(varchar,dp.createddate,108) + char(13) + char(10) + 'S: ' + dp.subyektif + char(13) + char(10) + 'O: ' + dp.obyektif + char(13) + char(10) + 'A: ' + dp.asesmen + char(13) + char(10) + 'P: ' + dp.planning end as note from soapnote dp left join registrasi reg on dp.idregistrasi=reg.idregistrasi left join transactiontype tt on dp.transactiontype=tt.idtransactiontype left join spesialis ps on dp.idspesialiscreator=ps.idspesialis left join paramedis pa on dp.idparamediscreator=pa.idparamedis left join sys_generalcode pt on pa.paramedistype=pt.idgeneral and pt.gctype='PARAMEDISTYPE' left join sys_generalcode dt on dp.paramediscreatortype=dt.idgeneral and dt.gctype='DPJPTYPE' left join sys_generalcode sd on dp.isdeleted=sd.idgeneral and sd.gctype='DELETE' where reg.idrekammedis='" & idrm & "' and convert(varchar,dp.soapnotedate,105)='" & Format(tanggal, "dd-MM-yyyy") & "' and dp.soapnotetype=4 order by dp.createddate desc", "dpjp")
        ...
        Else
            sqls.DMLQuery("select case when tt.iddepartment in (select value from sys_appsetting where variable in('IDICUDept','IDICCUDept','IDHCUDept')) then 'OK' else 'NOT' end as cekdept,dp.idsoapnote,dp.idparamediscreator,dp.idspesialiscreator,dp.paramediscreatortype,pa.nama as paramedis,ps.nama as spesialis,dt.generalcode as dpjptype,sd.generalcode as statdata,dp.planning,dt.priority as dpjpprioritas,dp.isdeleted,case when pt.idreff=1 then isnull(pa.nama,0) + isnull(' (' + ps.nama + ')' ,'') + case when dp.reviewedby is null then ' - Belum Direview' else ' - Sudah Direview' end + char(13) + char(10) + 'sebagai ' + dt.generalcode + ' ' + convert(varchar,dp.createddate,105) + ' ' + convert(varchar,dp.createddate,108) + char(13) + char(10) + 'S: ' + dp.subyektif + char(13) + char(10) + 'B: ' + dp.obyektif + char(13) + char(10) + 'A: ' + dp.asesmen + char(13) + char(10) + 'R: ' + dp.planning else isnull(pa.nama,0) + isnull(' (' + ps.nama + ')' ,'') + case when dp.reviewedby is null then ' - Belum Direview' else ' - Sudah Direview' end + char(13) + char(10) + 'sebagai ' + dt.generalcode + ' ' + convert(varchar,dp.createddate,105) + ' ' + convert(varchar,dp.createddate,108) + char(13) + char(10) + 'S: ' + dp.subyektif + char(13) + char(10) + 'O: ' + dp.obyektif + char(13) + char(10) + 'A: ' + dp.asesmen + char(13) + char(10) + 'P: ' + dp.planning end as note from soapnote dp left join registrasi reg on dp.idregistrasi=reg.idregistrasi left join transactiontype tt on dp.transactiontype=tt.idtransactiontype left join spesialis ps on dp.idspesialiscreator=ps.idspesialis left join paramedis pa on dp.idparamediscreator=pa.idparamedis left join sys_generalcode pt on pa.paramedistype=pt.idgeneral and pt.gctype='PARAMEDISTYPE' left join sys_generalcode dt on dp.paramediscreatortype=dt.idgeneral and dt.gctype='DPJPTYPE' left join sys_generalcode sd on dp.isdeleted=sd.idgeneral and sd.gctype='DELETE' where reg.idrekammedis='" & idrm & "' and convert(varchar,dp.soapnotedate,105)='" & Format(tanggal, "dd-MM-yyyy") & "' and dp.soapnotetype=4 and dp.isdeleted=0 order by dp.createddate desc", "dpjp")
