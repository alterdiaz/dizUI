...
Public Class frmAMIGD201801
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Else
            ...
            If cari.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                If sqls.getDataSet("getidrm", 0, "remarks") = "IGD ELEKTIF" Then
                    btnElektif.Text = "REGULER"
                Else
                    btnElektif.Text = "ELEKTIF"
                End If
                ...
                If iddso <> "-1" Then
                    sqls.DMLQuery("select soapnoteno,convert(varchar,soapnotedate,105)+' '+convert(varchar,soapnotedate,108) as soapnotedate,subyektif,obyektif,asesmen,planning from soapnote where idregistrasi='" & idreg & "' and isdeleted=0 and soapnotetype=1", "getso")
                    teNoSOAP.Tag = iddso
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        btnElektif.Size = New Size(80, 24)
        getRegex(dbstring)
        If formTitle <> "" Then
            Me.Text = formTitle
    ...
    Private Sub btnRegStatus_Click(sender As Object, e As EventArgs) Handles btnRegStatus.Click
        Dim sqls As New SQLs(dbstring)
        sqls.DMLQuery("select variable,value from sys_appsetting where variable in('idigddept')", "getid")
    ...
    Private Sub btnElektif_Click(sender As Object, e As EventArgs) Handles btnElektif.Click
        If idselect = "-1" Then
            dizMsgbox("Register belum dipilih", dizMsgboxStyle.Peringatan, Me)
            Exit Sub
        End If
        If btnElektif.Text = "REGULER" Then
            btnElektif.Text = "ELEKTIF"
            Dim sqls As New SQLs(dbstring)
            sqls.DMLQuery("update registrasi set remarks='-',updateddate=getdate(),updatedby='" & userid & "' where idregistrasi='" & idreg & "'", False)
        ElseIf btnElektif.Text = "ELEKTIF" Then
            btnElektif.Text = "REGULER"
            Dim sqls As New SQLs(dbstring)
            sqls.DMLQuery("update registrasi set remarks='IGD ELEKTIF',updateddate=getdate(),updatedby='" & userid & "' where idregistrasi='" & idreg & "'", False)
        End If
    End Sub

    Private Sub btnAntrianCALL_Click(sender As Object, e As EventArgs) Handles btnAntrianCALL1.Click, btnAntrianCALL2.Click, btnAntrianCALL3.Click, btnAntrianCALL4.Click, btnAntrianCALL5.Click

    End Sub

    Private Sub btnAntrianCCL_Click(sender As Object, e As EventArgs) Handles btnAntrianCCL1.Click, btnAntrianCCL2.Click, btnAntrianCCL3.Click, btnAntrianCCL4.Click, btnAntrianCCL5.Click

    End Sub

    Private Sub btnAntrianACC_Click(sender As Object, e As EventArgs) Handles btnAntrianACC1.Click, btnAntrianACC2.Click, btnAntrianACC3.Click, btnAntrianACC4.Click, btnAntrianACC5.Click

    End Sub

    Private Sub btnAntrian_Click(sender As Object, e As EventArgs) Handles btnAntrian1.Click, btnAntrian2.Click, btnAntrian3.Click, btnAntrian4.Click, btnAntrian5.Click
