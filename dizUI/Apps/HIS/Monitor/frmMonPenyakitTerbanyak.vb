Public Class frmMonPenyakitTerbanyak
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        sqls.CallSP("spMonPenyakitTerbanyak", "monpenyakitterbanyak", field, value)
        ...
        gvData.ViewCaption = "Penyakit Terbanyak - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
