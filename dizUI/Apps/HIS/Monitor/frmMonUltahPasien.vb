Public Class frmMonUltahPasien
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        value.AddRange(New Object() {CDate(deTanggal.EditValue)})
        sqls.CallSP("spMonUltahPasien", "monultah", field, value)

        gcData.DataSource = sqls.dataTable("monultah")
        gvData.BestFitColumns()
        gvData.ViewCaption = "Ulang Tahun Pasien - " & Format(CDate(deTanggal.EditValue), "dd ") & NamaBulan(CDate(deTanggal.EditValue).Month)
