Public Class frmMonRegisterAll
    ...
    Private Sub loadLOV()
        ...
        sqls.DMLQuery("select iddepartment as id,department as content from department where iddepartment in(select value from sys_appsetting where variable in('idigddept','idicudept','idirnadept','idlabdept','idnicudept','idibsdept','IDIRJDept','idpicudept','idirmdept','idraddept')) order by department asc", "dept")
    ...
    Private Sub loadgrid()
        ...
        sqls.DMLQuery("select variable,value from sys_appsetting where variable in('idigddept','idicudept','idirnadept','idlabdept','idnicudept','idibsdept','IDIRJDept','idpicudept','idirmdept','idraddept') and convert(varchar,value)='" & lueDepartment.EditValue & "'", "cek")
        If lueJenis.EditValue = CLng(1) Then
            If CStr(sqls.getDataSet("cek", 0, "variable")).ToLower = "idigddept" Then
            ...
            ElseIf CStr(sqls.getDataSet("cek", 0, "variable")).ToLower = "IDIRJDept" Then
                field.AddRange(New String() {"@tahun", "@bulan", "@tanggal"})
                value.AddRange(New Object() {CDate(deTanggal.EditValue).Year, CDate(deTanggal.EditValue).Month, CDate(deTanggal.EditValue).Day})
            ...
            ElseIf CStr(sqls.getDataSet("cek", 0, "variable")).ToLower = "idirmdept" Then
                field.AddRange(New String() {"@tahun", "@bulan", "@tanggal"})
                value.AddRange(New Object() {CDate(deTanggal.EditValue).Year, CDate(deTanggal.EditValue).Month, CDate(deTanggal.EditValue).Day})
            ...
            ElseIf CStr(sqls.getDataSet("cek", 0, "variable")).ToLower = "idibsdept" Then
                field.AddRange(New String() {"@tahun", "@bulan", "@tanggal"})
                value.AddRange(New Object() {CDate(deTanggal.EditValue).Year, CDate(deTanggal.EditValue).Month, CDate(deTanggal.EditValue).Day})
