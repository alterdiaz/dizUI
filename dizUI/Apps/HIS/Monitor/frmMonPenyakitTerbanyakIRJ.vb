Public Class frmMonPenyakitTerbanyakIRJ
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        sqls.CallSP("spMonPenyakitTerbanyakIRJ", "monpenyakitterbanyak", field, value)

        gcData.DataSource = sqls.dataTable("monpenyakitterbanyak")
        For i As Integer = 0 To gvData.RowCount - 1
            gvData.SetRowCellValue(i, GridColumn1, i + 1)
        Next
        gvData.BestFitColumns()
        gvData.ViewCaption = "Penyakit Terbanyak - IRJ " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
