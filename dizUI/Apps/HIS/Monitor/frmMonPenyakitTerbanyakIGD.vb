Public Class frmMonPenyakitTerbanyakIGD
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        sqls.CallSP("spMonPenyakitTerbanyakIGD", "monpenyakitterbanyak", field, value)
        ...
        gvData.ViewCaption = "Penyakit Terbanyak - IGD " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
