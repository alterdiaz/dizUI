Public Class frmMonDemografiPasienPeta
    Const HTCAPTION = &H2
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim sda As New DevExpress.XtraMap.ShapefileDataAdapter
        sda.FileUri = New System.Uri(CheckAndRepairValidPath(Application.StartupPath) & "WorldMap.shp", System.UriKind.Absolute)
        Dim vil As New DevExpress.XtraMap.VectorItemsLayer
        vil.Data = sda
        mcPeta.Layers.Add(vil)
        mcPeta.ZoomLevel = 3
    End Sub

    Private Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        If mcPeta.Layers.Count = 1 Then
            Dim exp As New frmExportMap(mcPeta)
            tambahChild(exp)
            exp.ShowDialog()
        Else
