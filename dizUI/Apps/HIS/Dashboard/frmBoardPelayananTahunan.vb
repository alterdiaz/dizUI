...
Public Class frmBoardPelayananTahunan
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(sender As Object, e As EventArgs) Handles deTanggal.EditValueChanged
        ...
        loadRegisterHarian(Format(CDate(deTanggal.EditValue), "yyyy"))
        loadRegisterIGD(Format(CDate(deTanggal.EditValue), "yyyy"))
        loadRegisterDept(Format(CDate(deTanggal.EditValue), "yyyy"))
        loadRegister(Format(CDate(deTanggal.EditValue), "yyyy"))
        loadAPS(Format(CDate(deTanggal.EditValue), "yyyy"))
        loadASM(Format(CDate(deTanggal.EditValue), "yyyy"))
        loadPenyakit(Format(CDate(deTanggal.EditValue), "yyyy"))
        loadBL(Format(CDate(deTanggal.EditValue), "yyyy"))
    ...
    Private Sub loadRegisterDept(param As String)
        ...
        sqls.CallSP("spTahunRegistrasi", "reg", field, value)
    ...
    Private Sub loadRegister(param As String)
        ...
        ct.EnableAntialiasing = True
        ct.Font = New System.Drawing.Font("Tahoma", 10.0!)
        ct.Text = "Status Registrasi - " & CDate(deTanggal.EditValue).Year
        ct.Alignment = StringAlignment.Center
        ct.EnableAntialiasing = DevExpress.Utils.DefaultBoolean.True
        ct.TextColor = Color.Black
    ...
    Private Sub loadRegisterIGD(param As String)
        ...
        field.AddRange(New String() {"@periode"})
        value.AddRange(New String() {param})
        sqls.CallSP("spTahunRegIGD", "reg", field, value)
        ...
        ct.EnableAntialiasing = True
        ct.Font = New System.Drawing.Font("Tahoma", 10.0!)
        ct.Text = "Registrasi IGD - " & CDate(deTanggal.EditValue).Year
        ct.Alignment = StringAlignment.Center
        ct.EnableAntialiasing = DevExpress.Utils.DefaultBoolean.True
        ct.TextColor = Color.Black
    ...
    Private Sub loadRegisterHarian(param As String)
        ...
        field.AddRange(New String() {"@periode"})
        value.AddRange(New String() {param})
        sqls.CallSP("spTahunanReg", "reg", field, value)
        ...
        ct.EnableAntialiasing = True
        ct.Font = New System.Drawing.Font("Tahoma", 10.0!)
        ct.Text = "Registrasi Bulanan - " & CDate(deTanggal.EditValue).Year
        ct.Alignment = StringAlignment.Center
        ct.EnableAntialiasing = DevExpress.Utils.DefaultBoolean.True
        ct.TextColor = Color.Black
    ...
    Private Sub loadAPS(param As String)
        ...
        field.AddRange(New String() {"@periode"})
        value.AddRange(New String() {param})
        sqls.CallSP("spTahunAPS", "reg", field, value)
        ...
        ct.EnableAntialiasing = True
        ct.Font = New System.Drawing.Font("Tahoma", 10.0!)
        ct.Text = "Pasien APS - " & CDate(deTanggal.EditValue).Year
        ct.Alignment = StringAlignment.Center
        ct.EnableAntialiasing = DevExpress.Utils.DefaultBoolean.True
        ct.TextColor = Color.Black
        ccAPS.Titles.Clear()
    ...
    Private Sub loadASM(param As String)
        ...
        field.AddRange(New String() {"@periode"})
        value.AddRange(New String() {param})
        sqls.CallSP("spTahunASM", "reg", field, value)
        ...
        ct.EnableAntialiasing = True
        ct.Font = New System.Drawing.Font("Tahoma", 10.0!)
        ct.Text = "Assessment Medis - " & CDate(deTanggal.EditValue).Year
        ct.Alignment = StringAlignment.Center
        ct.EnableAntialiasing = DevExpress.Utils.DefaultBoolean.True
        ct.TextColor = Color.Black
        ccASM.Titles.Clear()
    ...
    Private Sub loadPenyakit(param As String)
        ...
        field.AddRange(New String() {"@periode"})
        value.AddRange(New String() {param})
        sqls.CallSP("spTahunPenyakitTerbanyak", "reg", field, value)
        ...
        ct.EnableAntialiasing = True
        ct.Font = New System.Drawing.Font("Tahoma", 10.0!)
        ct.Text = "Penyakit Terbanyak - " & CDate(deTanggal.EditValue).Year
        ct.Alignment = StringAlignment.Center
        ct.EnableAntialiasing = DevExpress.Utils.DefaultBoolean.True
        ct.TextColor = Color.Black
    ...
    Private Sub loadBL(param As String)
        ...
        field.AddRange(New String() {"@periode"})
        value.AddRange(New String() {param})
        sqls.CallSP("spTahunBaruLama", "reg", field, value)
        ...
        ct.EnableAntialiasing = True
        ct.Font = New System.Drawing.Font("Tahoma", 10.0!)
        ct.Text = "Pasien Baru/Lama - " & CDate(deTanggal.EditValue).Year
        ct.Alignment = StringAlignment.Center
        ct.EnableAntialiasing = DevExpress.Utils.DefaultBoolean.True
        ct.TextColor = Color.Black
        ccPxLB.Titles.Clear()
