...
Public Class frmDashboardPelayananTahunan
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(sender As Object, e As EventArgs) Handles deTanggal.EditValueChanged
        ...
        loadAPSrad(Format(CDate(deTanggal.EditValue), "yyyy"))
        loadAPSlab(Format(CDate(deTanggal.EditValue), "yyyy"))
        loadODS(Format(CDate(deTanggal.EditValue), "yyyy"))
        loadICD(Format(CDate(deTanggal.EditValue), "yyyy"))
        loadParamedis(Format(CDate(deTanggal.EditValue), "yyyy"))
    ...
    Private Sub loadRegisterIGD(param As String)
        ...
        field.AddRange(New String() {"@periode"})
        value.AddRange(New String() {param})
        sqls.CallSP("spTahunanIGD", "reg", field, value)
    ...
    Private Sub loadAPSlab(param As String)
        ...
        field.AddRange(New String() {"@periode"})
        value.AddRange(New String() {param})
        sqls.CallSP("spTahunanAPSlab", "reg", field, value)
    ...
    Private Sub loadAPSrad(param As String)
        ...
        field.AddRange(New String() {"@periode"})
        value.AddRange(New String() {param})
        sqls.CallSP("spTahunanAPSrad", "reg", field, value)
    ...
    Private Sub loadODS(param As String)
        ...
        field.AddRange(New String() {"@periode"})
        value.AddRange(New String() {param})
        sqls.CallSP("spTahunanODS", "reg", field, value)
    ...
    Private Sub loadICD(param As String)
        ...
        field.AddRange(New String() {"@periode"})
        value.AddRange(New String() {param})
        sqls.CallSP("spTahunanICD", "reg", field, value)
    ...
    Private Sub loadParamedis(param As String)
        ...
        field.AddRange(New String() {"@periode"})
        value.AddRange(New String() {param})
        sqls.CallSP("spTahunanParamedis", "reg", field, value)
