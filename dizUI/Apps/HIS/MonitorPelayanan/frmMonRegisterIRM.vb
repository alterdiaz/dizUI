Public Class frmMonRegisterIRM
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        sqls.CallSP("spMonRegisterRHB", "monregrhb", field, value)

        gcData.DataSource = sqls.dataTable("monregrhb")
        ...
        gvData.ViewCaption = "Register Rehabilitasi Medik - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
