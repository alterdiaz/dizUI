Public Class frmMonRegisterHD
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        sqls.CallSP("spMonRegisterHD", "monreghd", field, value)

        gcData.DataSource = sqls.dataTable("monreghd")
        ...
        gvData.ViewCaption = "Register HD - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
