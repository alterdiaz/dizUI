Public Class frmMonRegisterCATH
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        sqls.CallSP("spMonRegisterCATH", "monregcath", field, value)

        gcData.DataSource = sqls.dataTable("monregcath")
        ...
        gvData.ViewCaption = "Register CATH - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
