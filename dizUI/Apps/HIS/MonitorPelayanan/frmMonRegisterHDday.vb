Public Class frmMonRegisterHDday
    Const HTCAPTION = &H2
    ...
    Private Sub loadgrid()
        ...
        sqls.CallSP("spMonRegisterHDDay", "monreg", field, value)
        gvData.ViewCaption = "Register HD - " & CDate(deTanggal.EditValue).Day & " " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
