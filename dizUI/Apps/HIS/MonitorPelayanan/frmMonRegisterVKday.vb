Public Class frmMonRegisterVKday
    Const HTCAPTION = &H2
    ...
    Private Sub loadgrid()
        ...
        sqls.CallSP("spMonRegisterVKDay", "monreg", field, value)
        gvData.ViewCaption = "Register VK - " & CDate(deTanggal.EditValue).Day & " " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
