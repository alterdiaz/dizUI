Public Class frmMonRegisterMCUday
    Const HTCAPTION = &H2
    ...
    Private Sub loadgrid()
        ...
        sqls.CallSP("spMonRegisterMCUDay", "monreg", field, value)
        gvData.ViewCaption = "Register MCU - " & CDate(deTanggal.EditValue).Day & " " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
    ...
    Private Sub previewBerkasAMMCU(iddata As String, idreg As String, nomorform As String, cetaktype As cu)
        If nomorform = "AMMCU201801" Then
            AMMCU201801(iddata, idreg, cetaktype)
        End If
    End Sub

    Private Sub AMMCU201801(iddata As String, idreg As String, cetaktype As cu)
        Dim field As New List(Of String)
        Dim value As New List(Of Object)
        ...
        mys.CallSP("spAMMCU201801", "asmmcu", field, value)
        ...
        rpt.DataMember = "asmmcu"
        rpt.DisplayName = "AMMCU201801"
