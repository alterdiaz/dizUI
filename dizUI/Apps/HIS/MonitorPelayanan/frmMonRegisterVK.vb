Public Class frmMonRegisterVK
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        sqls.CallSP("spMonRegisterVK", "monregvk", field, value)

        gcData.DataSource = sqls.dataTable("monregvk")
        ...
        gvData.ViewCaption = "Register Verlos Kamer - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
