Public Class frmMonRegisterMCU
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        sqls.CallSP("spMonRegisterMCU", "monregmcu", field, value)

        gcData.DataSource = sqls.dataTable("monregmcu")
        ...
        gvData.ViewCaption = "Register MCU - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
