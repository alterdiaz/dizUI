Public Class frmMonRegisterIRJ
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        sqls.CallSP("spMonRegisterRJ", "monregrj", field, value)

        gcData.DataSource = sqls.dataTable("monregrj")
        ...
        gvData.ViewCaption = "Register Rawat Jalan - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
