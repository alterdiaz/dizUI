Public Class frmMonRegisterCATHday
    Const HTCAPTION = &H2
    ...
    Private Sub loadgrid()
        ...
        sqls.CallSP("spMonRegisterCATHDay", "monreg", field, value)
        gvData.ViewCaption = "Register CATH - " & CDate(deTanggal.EditValue).Day & " " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
