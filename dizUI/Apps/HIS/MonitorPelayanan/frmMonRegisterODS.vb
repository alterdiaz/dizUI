Public Class frmMonRegisterODS
    Const HTCAPTION = &H2
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged
        ...
        sqls.CallSP("spMonRegisterODS", "monregods", field, value)

        gcData.DataSource = sqls.dataTable("monregods")
        ...
        gvData.ViewCaption = "Register ODS - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year
