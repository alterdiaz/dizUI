Public Class frmResultRadiologi
    Const HTCAPTION = &H2
    ...
    Private Sub loadgrid()
        Dim sqls As New SQLs(dbstring)
        sqls.DMLQuery("select '' as idtransaksidt,i.iditem,i.itemtype,i.idsatuan,gc.generalcode as type,i.kode,i.item,s.satuan,0 as qty,0 as qtylalu,0 as qtyask,'-' as remarks,i.iditemgrup,ig.itemgrup,'0' as idbusinesspartner,0 as harga,'' as isdonestr,0 as isdone,convert(bigint,0) as valueint1,convert(bigint,0) as valueint2,convert(decimal(18,3),0) as valuedec1 from item i left join itemgrup ig on i.iditemgrup=ig.iditemgrup left join sys_generalcode gc on gc.idgeneral=i.itemtype and gc.gctype='ITEMTYPE' left join satuan s on s.idsatuan=i.idsatuan where 1=0", "getnull")
    ...
    Private Sub frmResultRadiologi_Load(sender As Object, e As EventArgs) Handles Me.Load
        If formTitle <> "" Then
            Me.Text = formTitle
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        field.AddRange(New String() {"idtransaksi", "updatedby", "updateddate", "updatedfromip", "updatedfromhostname", "remarks"})
        value.AddRange(New Object() {idTrans, userid, nowTime, ipadd, hostname, teRemarks.Text})
        If dsqls.datasetSave("transaksi", idTrans, field, value, False) = True Then
            ...
            field.AddRange(New String() {"idtransaksidt", "updatedby", "updateddate", "updatedfromip", "updatedfromhostname", "valuedec1", "valuedec2", "valuedec3", "valuestr1", "valuestr2", "valuestr3", "valueint1", "valueint2", "valueint3"})
            For a As Integer = 0 To gvData.RowCount - 1
                ...
                value.AddRange(New Object() {dr("idtransaksidt"), userid, nowTime, ipadd, hostname, dr("valuedec1"), 0, 0, "-", "-", "-", dr("valueint1"), dr("valueint2"), 0})
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        If cari.ShowDialog = Windows.Forms.DialogResult.OK Then
            ...
            sqls.DMLQuery("select idtransaksi,transaksitype,transaksino,remarks,convert(varchar,createddate,105)+' '+convert(varchar,createddate,108) as createddate from transaksi where idtransaksireff='" & idReg & "' and transaksistatus=8", "gettranshd")
            ...
            sqls.DMLQuery("select t.idtransaksidt,t.iditem,t.itemtype,t.idsatuan,t.type,t.kodeitem as kode,t.item,t.satuan,t.qtydispose as qty,t.qtydispose as qtylalu,t.qtydispose as qtyask,t.remarks,i.iditemgrup,ig.itemgrup,t.idbusinesspartner,isnull(t.harga,0) as harga, case when t.isdone=0 then 'Belum' when t.isdone=1 then 'Konfirm' end as isdonestr,t.isdone,t.valueint1,t.valueint2,t.valueint3,t.valuedec1,t.valuedec2,t.valuedec3,t.valuestr1,t.valuestr2,t.valuestr3 from transaksidt t left join item i on t.iditem=i.iditem left join itemgrup ig on i.iditemgrup=ig.iditemgrup where t.idtransaksi='" & idTrans & "' order by t.createddate asc", "getdetil")
    ...
    Private Sub btnSavePrint_Click(sender As Object, e As EventArgs) Handles btnSavePrint.Click
        ...
        If dsqls.datasetSave("transaksi", idTrans, field, value, False) = True Then
            ...
            If cekval = True Then
                ...
                Dim sharename As String = getPrinter("FORMRAD")
                If sharename <> "" Then
                    Try
                        pt.Print(sharename)
    ...
    Private Sub btnCetak_Click(sender As Object, e As EventArgs) Handles btnCetak.Click
        ...
        If cari.ShowDialog = Windows.Forms.DialogResult.OK Then
            ...
            Dim mys As New SQLs(dbstring)
            mys.CallSP("spTransaksiPenunjang", "formrad", field, value)
