Public Class frmOrderLaboratorium
    ...
    Private Sub frmOrderLaboratorium_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If _idreginduk <> "" Then
            ...
            Else
                ...
                sqls.DMLQuery("select idrekammedis,payertype,asalpx,asalpx2,idpayer,idasuransi,ishamil,idkelas from registrasi where idregistrasi='" & _idreginduk & "'", "getidrm")
                ...
                value.AddRange(New Object() {idReg, _idreginduk, idRegType, idjadwalsesi, idcomp, iddept, idunit, idRegType, idrm, idlokasi, idkelas, idparamedis, idspesialis, teNoRegistrasi.Text, cnt + 1, cntdokter + 1, cntdept + 1, 0, 0, 0, 0, CLng(2), 0, teRemarks.Text, payertype, idpayer, idasuransi, ishamil, 0, "-", userid, 0})
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If dsqls.datasetSave("transaksi", idTrans, field, value, False) = True Then
            ...
            Next
            If cekval = True Then
                dizMsgbox("Order Laboratorium telah tersimpan", dizMsgboxStyle.Info, Me)
            End If
        End If
    End Sub
