Public Class frmKamarService
    ...
    Private Sub btnRefresh_Click(sender As Object, e As EventArgs) Handles btnRefresh.Click
        ...
        sqls.CallSP("spMonKamarService", "monkamar")
        ...
        gvData.ViewCaption = "Monitoring Service Kamar - " & nowTime.Day & " " & NamaBulan(nowTime.Month) & " " & nowTime.Year
