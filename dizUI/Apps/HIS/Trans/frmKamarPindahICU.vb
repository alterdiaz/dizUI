Public Class frmKamarPindahICU
    Const HTCAPTION = &H2
    ...
    Private Sub loadLOV()
        ...
        sqls.DMLQuery("select distinct l.idlokasi as id,k.kelas,l.nama as content from lokasi l left join kelaskamar kk on l.idlokasi=kk.idlokasi left join kelas k on kk.idkelas=k.idkelas and k.isdeleted=0 where l.isdeleted=0 and l.idlokasi in (select idlokasi from kamar where checkin is null and statusbed=1) and l.lokasitype=22 and l.iddepartment in (select value from sys_appsetting where variable in ('IDICUDept','IDHCUDept','IDICCUDept')) order by k.kelas asc,l.nama asc", "ruangtujuan")
    ...
    Private Sub btnNew_Click(sender As Object, e As EventArgs) Handles btnNew.Click
        ...
        value.AddRange(New Object() {"IDICUDept,IDHCUDept,IDICCUDept"})
