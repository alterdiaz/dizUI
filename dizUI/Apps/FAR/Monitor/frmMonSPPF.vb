Public Class frmMonSPPF
    ...
    Private Sub deTanggal_EditValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles deTanggal.EditValueChanged, lueUnit.EditValueChanged
        ...
        Try
            ...
            sqls.CallSP("spMonSPPF", "parent", field, value)
            ...
            sqls.CallSP("spMonSPPFdt", "child", field2, value2)
            ...
            'Next
            gvData.BestFitColumns()
            gvData.ViewCaption = "Permintaan Pembelian Farmasi - " & NamaBulan(CDate(deTanggal.EditValue).Month) & " " & CDate(deTanggal.EditValue).Year & " " & lueUnit.Text
