...
Public Class frmPermintaanPembelianFarmasiAllUnit
    ...
    Private Sub loadgrid(idunit As String)
        ...
        sqls.CallSP("spSPPF", "spp") ', field, value)
        dttbl = sqls.dataTable("spp")
        gcData.DataSource = dttbl

        Dim sqls1 As New SQLs(dbstring)
        sqls1.CallSP("spSPPFturunan", "sppturunan") ', field, value)
