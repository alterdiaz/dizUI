Public Class frmNewPayment
    ...
    Private Function getidcompanyproduct(idcompany As String, idproduct As String, idhardware As String) As String
        ...
        If sqls.getDataSet("getidcompproduct") > 0 Then
            retval = CStr(sqls.getDataSet("getidcompproduct", 0, "idcompanyproduct"))
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        vs.AddRange(New Object() {idpaymentonline, lueRekening.EditValue, idcompanyproduct, luePaket.EditValue, tePaymentNo.Text, CDate(deTanggal.EditValue), tePaket.Tag, tePaket.Text, teBank.Text, teNorek.Text, teNama.Text, meRemarks.Text, 0, 0, "", tmpnowTime, tmpUserID})

        If dtsqls.datasetSave("payment", idpaymentonline, fs, vs, False) = True Then
            sqls = New SQLs(mystring)
            ...
            vs.AddRange(New Object() {idtmp, idpaymentonline, lueRekening.EditValue, IIf(idcompanyproduct = -1, DBNull.Value, idcompanyproduct), luePaket.EditValue, tePaymentNo.Text, CDate(deTanggal.EditValue), tePaket.Tag, tePaket.Text, teBank.Text, teNorek.Text, teNama.Text, meRemarks.Text, 0, 0, "", tmpnowTime, tmpUserID})
    ...
    Private Sub btnExistCheck_Click(sender As Object, e As EventArgs) Handles btnExistCheck.Click
        ...
        vs.AddRange(New String() {idpaymentonline, vid, 1, idcompanyproduct, 0, tePaymentNo.Text, Format(tmpnowTime, "dd-MM-yyyy"), vnominal, vnominaldata, "Voucher", "-", "Voucher", "Voucher", 1, 0, "-", tmpUserID, tmpnowTime})
        ...
        If dtsqls.datasetSave("payment", idpaymentonline, fs, vs, False) = True Then
            ...
            vlite.AddRange(New Object() {idtmp, idpaymentonline, vid, 1, idcompanyproduct, DBNull.Value, tePaymentNo.Text, tmpnowTime, vnominal, vnominaldata, teBank.Text, teNorek.Text, teNama.Text, meRemarks.Text, 1, 0, "", tmpnowTime, tmpUserID})
            Dim dtlite As New dtsetSQLI(dblite)
            dtlite.datasetSave("payment", idtmp, flite, vlite, False)
