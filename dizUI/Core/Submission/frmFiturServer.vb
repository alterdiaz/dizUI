Public Class frmFiturServer
    ...
    Private Sub btnComputerList_Click(sender As Object, e As EventArgs) Handles btnComputerList.Click
        Dim complist As New frmComputerClient
        complist.ShowDialog(Me)
    End Sub
