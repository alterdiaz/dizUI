Public Class frmSettingDB
    ...
    Private Sub frmSettingDB_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        lite.DMLQuery("select iddbconn,databasename,ipserver,port,username,password,dbtype from dbconn where dblocation='SERVER'", "getdbstring")
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        value.AddRange(New String() {idData, tboDBname.Text, tboDBsvr.Text, tboDBport.Text, tboDBuid.Text, tboDBpwd.Text, lueDBtype.EditValue, "SERVER"})
    ...
    Private Function checkEntry() As Boolean
        ...
        If tboDBname.Text = "" Then
            retval = False
        End If
        If tboDBport.Text = "" Then
            retval = False
        End If
        If tboDBpwd.Text = "" Then
            retval = False
        End If
        If tboDBsvr.Text = "" Then
            retval = False
        End If
        If tboDBuid.Text = "" Then
            retval = False
        End If
        If lueDBtype.EditValue Is Nothing Then
            retval = False
        End If
        ...
        End If
        If tboDBport.Text <> "" Then
            If CInt(tboDBport.Text) > 65536 Then
                retval = False
            End If
            If CInt(tboDBport.Text) < 0 Then
                retval = False
            End If
        End If
        Return retval
