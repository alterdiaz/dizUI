...
#Region "Method"
    Public Sub New(ByVal NamaDatabase As String, ByVal NamaServer As String, ByVal Port As String, ByVal UserID As String, ByVal PassWD As String)
        strConn = "Database=" & NamaDatabase & ";server=" & NamaServer & ":" & Port & ";uid=" & UserID & ";pwd=" & PassWD & ";Connection Timeout=0"
    End Sub

    Public Sub New(ByVal NamaDatabase As String, ByVal NamaServer As String)
        strConn = "Server=" & NamaServer & ";Database=" & NamaDatabase & ";Trusted_Connection=True;Connection Timeout=0"
    End Sub
