...
Module modCore
    ...
    Public Function readSettingFile() As String
        ...
        Dim myi As New SQLi(dblite)
        myi.DMLQuery("select databasename || '|' || ipserver || '|' || port || '|' || schema || '|' || username || '|' || password as dbstring from dbconn where dbtype='SQLS' and dblocation='SERVER'", "getdbstring")
    ...
    Public Function generateno2(idunit As Long, iddept As Long, jenistransaksi As String, isbaru As Boolean) As KeyValuePair(Of String, String)
        Dim sqls As New SQLs(dbstring)
        ...
        If sqls.getDataSet("getformat") = 0 Then
            ...
            value.AddRange(New Object() {-1, iddept, idunit, kdtrans, jenistransaksi, kdtrans & "/", fmttrans, "Belakang", 4, idcomp})
            dtsqls.datasetSave("transactiontype", -1, field, value, False)
        End If
