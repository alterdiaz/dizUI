Public Class frmNewCompany
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        value.AddRange(New Object() {idData, IIf(tmpidcompanyrefferal = -1, 0, tmpidcompanyrefferal), compcode, compnameunique, teCompNickname.Text, teCompFullname.Text, lueCompJenis.EditValue, teCompNPWP.Text, teCompEmail.Text, emailpin, tmpnowTime.AddDays(30), 0, teAlamat.Text, teKodepos.Text, lueRegion1.EditValue, lueRegion2.EditValue, IIf(lueRegion3.EditValue Is Nothing, CLng(0), lueRegion3.EditValue), IIf(lueRegion4.EditValue Is Nothing, CLng(0), lueRegion4.EditValue), IIf(lueRegion5.EditValue Is Nothing, CLng(0), lueRegion5.EditValue), addresspin, tmpnowTime.AddDays(30), 0, teFax.Text, tePhone1.Text, tePhone2.Text, IIf(lueCompJenis.EditValue = 0, 1, 0), 0, "-", teCPname.Text, teCPno.Text, teCPemail.Text, tmpUserID, tmpnowTime, tmpidtoken, tmptokenkey1, tmptokenkey2})
    ...
    Private Sub frmNewCompany_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        sqls.DMLQuery("select idwilayah as idregion,wilayah as region from wilayah where idlevelwilayah=1 and isdeleted=0", "region1")
    ...
    Private Sub lueRegion1_EditValueChanged(sender As Object, e As EventArgs) Handles lueRegion1.EditValueChanged
        ...
        Else
            Dim sqls As New SQLs(mystring)
            sqls.DMLQuery("select idwilayah as idregion,wilayah as region from wilayah where idlevelwilayah=2 and isdeleted=0 and idparent=" & sender.editvalue, "region2")
    ...
    Private Sub lueRegion2_EditValueChanged(sender As Object, e As EventArgs) Handles lueRegion2.EditValueChanged
        ...
        Else
            Dim sqls As New SQLs(mystring)
            sqls.DMLQuery("select idwilayah as idregion,wilayah as region from wilayah where idlevelwilayah=3 and isdeleted=0 and idparent=" & sender.editvalue, "region3")
    ...
    Private Sub lueRegion3_EditValueChanged(sender As Object, e As EventArgs) Handles lueRegion3.EditValueChanged
        ...
        Else
            Dim sqls As New SQLs(mystring)
            sqls.DMLQuery("select idwilayah as idregion,wilayah as region from wilayah where idlevelwilayah=4 and isdeleted=0 and idparent=" & sender.editvalue, "region4")
