Public Class frmCurrentPayment
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        vs.AddRange(New Object() {-1, lueRekening.EditValue, IIf(idcompanyproduct = -1, "", idcompanyproduct), luePaket.EditValue, tePaymentNo.Text, Format(CDate(deTanggal.EditValue), "dd-MM-yyyy"), tePaket.Tag, tePaket.Text, teBank.Text, teNorek.Text, teNama.Text, meRemarks.Text, 0, 0, "-", tmpUserID})
        ...
        If dtsqls.datasetSave("payment", -1, fs, vs, False) = True Then
            ...
            vlite.AddRange(New Object() {-1, idpaymentonline, lueRekening.EditValue, IIf(idcompanyproduct = -1, DBNull.Value, idcompanyproduct), luePaket.EditValue, tePaymentNo.Text, CDate(deTanggal.EditValue), tePaket.Tag, tePaket.Text, teBank.Text, teNorek.Text, teNama.Text, meRemarks.Text, 0, 0, "", tmpnowTime, tmpUserID})
    ...
    Private Sub btnExistCheck_Click(sender As Object, e As EventArgs) Handles btnExistCheck.Click
        ...
        vs.AddRange(New Object() {-1, vid, idbankoption, idcompanyproduct, 0, tePaymentNo.Text, Format(tmpnowTime, "dd-MM-yyyy"), vnominal, vnominaldata, "Voucher", "-", "Voucher", "Voucher", 1, 0, "-", tmpUserID, tmpnowTime})
    ...
    Private Function getidproducttype(idcompany As Long, idproduct As Long, idhardware As Long) As Long
        ...
        retval = CLng(sqls.getDataSet("getidproducttype", 0, "idproducttype"))
        Return retval
    End Function
    ...
    Private Sub btnCheckQuota_Click(sender As Object, e As EventArgs) Handles btnCheckQuota.Click
        ...
        'sqls.DMLQuery("select isnull(sum(nominaldata),0) as nominaldata from datausage where idcompanyproduct=" & idcompanyproduct & " and isdeleted=0 and convert(varchar,postdate,105)=convert(varchar,(select max(postdate) as postdate from datausage where idcompanyproduct=" & idcompanyproduct & " and isdeleted=0),105)", "getusage")
