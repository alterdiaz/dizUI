...
Module modCore
    ...
    Public idcompany As Long = -1
    Public companyname As String = ""
    Public companycode As String = ""

    Public idproduct As Long = -1
    Public productname As String = ""
    Public productcode As String = ""
    Public productversion As String = ""
    Public idproducttype As Long = -1

    Public idcompanyrefferal As Long = -1
    Public idcompanyproduct As Long = -1
    ...
    Public idData As Long = -1
    Public idDataChild As Long = -1
    ...
    Public Function readSettingFileOnline() As String
        ...
        Dim myi As New SQLi(dblite)
        myi.DMLQuery("select databasename || '|' || ipserver || '|' || port || '|' || username || '|' || password as dbstring from dbconn where dbtype='SQLS' and dblocation='DOMAIN'", "getdbstring")
        If myi.getDataSet("getdbstring") > 0 Then
            retval = myi.getDataSet("getdbstring", 0, "dbstring")
        End If
        Return retval
                            ...
                            If a.ToString.Contains("System.Windows.Forms.TextBox") Then
                                If Not a.tag Is Nothing Then
                                    If a.tag.ToString.Contains("telepon") Or a.tag.ToString.Contains("phone") Then
                                        If IsNumeric(a.text) = False Then retVal = False
                            ...
                            ElseIf a.ToString.Contains("DevExpress.XtraEditors.TextEdit") Then
                                If Not a.tag Is Nothing Then
                                    ...
                                    ElseIf a.tag.ToString.Contains("email") Then
                                        ...
                                        End If
                                    Else
                                        If CType(a, DevExpress.XtraEditors.TextEdit).Text = "" Then retVal = False
                                    End If
                                End If
                            ElseIf a.ToString.Contains("DevExpress.XtraEditors.LookUpEdit") Then
                                If CType(a, DevExpress.XtraEditors.LookUpEdit).EditValue Is Nothing Then retVal = False
                            ElseIf a.ToString.Contains("DevExpress.XtraEditors.SpinEdit") Then
                                If CType(a, DevExpress.XtraEditors.SpinEdit).Value = 0 Then retVal = False
