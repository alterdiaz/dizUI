Public Class frmInfoboxRegReceiver
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        ...
        sqls.DMLQuery("update registrasi set receiveddate=getdate(),receivedby='" & userid & "' where idregistrasi='" & id & "'", False)
        Me.Dispose()
    End Sub
    ...
    Private Sub tmrWaktu_Tick(sender As Object, e As EventArgs) Handles tmrWaktu.Tick
        ...
        Dim sqls As New SQLs(dbstring)
        sqls.DMLQuery("select idregistrasi from registrasi where idregistrasi='" & id & "' and receivedby is not null", "cekdata")
