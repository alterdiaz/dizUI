Public Class frmInfoboxNotes
    ...
    Private Sub btnExit_Click(sender As Object, e As EventArgs) Handles btnExit.Click
        ...
        field.AddRange(New String() {"idusernotes", "warningdate"})
        value.AddRange(New Object() {id, nowTime.AddMinutes(30)})
        dtsqls.datasetSave("sys_usernotes", id, field, value, False)
        idnotes.RemoveAll(Function(val As String)
                              Return val = id
                          End Function)
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        ...
        sqls.DMLQuery("update sys_usernotes set completedate=getdate(),iscomplete=1 where idusernotes='" & id & "'", False)
        Me.Dispose()
    End Sub
    ...
    Private Sub tmrWaktu_Tick(sender As Object, e As EventArgs) Handles tmrWaktu.Tick
        ...
        Dim sqls As New SQLs(dbstring)
        sqls.DMLQuery("select idusernotes from sys_usernotes where idusernotes='" & id & "' and iscomplete=1", "cekdata")
