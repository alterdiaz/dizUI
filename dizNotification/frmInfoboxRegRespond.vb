Public Class frmInfoboxRegRespond
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        ...
        sqls.DMLQuery("update registrasi set responddate=getdate(),respondby='" & userid & "' where idregistrasi='" & id & "'", False)
        Me.Dispose()
    End Sub
    ...
    Private Sub tmrWaktu_Tick(sender As Object, e As EventArgs) Handles tmrWaktu.Tick
        ...
        Dim sqls As New SQLs(dbstring)
        sqls.DMLQuery("select idregistrasi from registrasi where idregistrasi='" & id & "' and respondby is not null", "cekdata")
