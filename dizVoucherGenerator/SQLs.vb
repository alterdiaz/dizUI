...
#Region "Overloads"
    ...
    Public Function CallSP(ByVal spName As String, ByVal TableName As String, ByVal ListParameter As List(Of String), ByVal ListValueParameter As List(Of Object)) As Boolean
        If ListParameter.Count = 0 Then
            MsgBox("List Parameter is null", MsgBoxStyle.Exclamation)
            Return False
            Exit Function
        End If
        If ListValueParameter.Count = 0 Then
            MsgBox("List Value Parameter is null", MsgBoxStyle.Exclamation)
            Return False
            Exit Function
        End If
        If ListParameter.Count <> ListValueParameter.Count Then
            MsgBox("List Parameter is not equal with List Value Parameter", MsgBoxStyle.Exclamation)
            Return False
            Exit Function
        End If
        'Me.checkConnection()
        ...
        Try
            ...
            If dtset.Tables("sysCekParam" & hash).Rows.Count <> ListParameter.Count Then
                MsgBox("List Parameter is not equal with Parameter on Stored Procedure", MsgBoxStyle.Exclamation)
                Return False
                Exit Function
            End If
    ...
    Public Overloads Function InsertImage(ByVal TableName As String, ByVal FieldName As String, ByVal ValueStr As String, ByVal FieldImg As String, ByVal ValueImg As String, ByVal ImageByte As Byte(), ByVal ShowMsg As Boolean) As Boolean
        ...
        Try
            ...
            If i > 0 And ShowMsg = True Then
                ...
                MsgBox("Data Image telah tersimpan", MsgBoxStyle.Information)
            End If
        ...
        Catch ex As Exception
            Try
                sqltrans.Rollback()
                MsgBox(ex.Message, MsgBoxStyle.Exclamation, Me)
                Return False
            Catch ex2 As Exception
                MsgBox(ex.Message, MsgBoxStyle.Exclamation, Me)
                Return False
